...
import Offers from '../components/platform/Offers';
import Mentoring from '../components/platform/Mentoring';
import PersonalBrand from '../components/platform/PersonalBrand';
import Profile from '../components/platform/Profile';
import SettingsComponent from '../components/platform/Settings';
import Help from '../components/platform/Help';
import Courses from '../components/platform/Courses';
import CoursePlayer from '../components/platform/CoursePlayer';
import Clients from '../components/platform/Clients';
import ClientDetails from '../components/platform/ClientDetails';
import BuyingClients from '../components/platform/BuyingClients';
import SellingClients from '../components/platform/SellingClients';
import ClientDatabase from '../components/platform/ClientDatabase';
import AdminDashboard from '../components/admin/AdminDashboard';
import Pozysk from '../components/platform/Pozysk';
import PozyskForm from '../components/platform/PozyskForm';
import TaskList from '../components/platform/tools/TaskList';
import Notes from '../components/platform/tools/Notes';
import OfferAnalysis from '../components/platform/tools/OfferAnalysis';
